...
int main() {
    ...
    /*std::vector<std::vector<double>> matrix = {{10, -1, 2, 0}, {0, 8, -1, 3}, {2, -1, 10, 0}, {-1, 3, -1, 11}};
    std::vector<double> vector = {-11, -11, 6, 25};

    std::cout << "bla-bla-bla" << std::endl;
    std::vector<double> s = {-1.38998, -1.73748, 0.310015, 2.0091 };
    std::vector<double> s2 = {-1.46, -2.35, 0.65, 2.84 };
    PrintVector(MatrixMultiplyVector(matrix, s));
    PrintVector(CGM(matrix, vector, 1e-8));*/
}